module.exports = {
  TOKEN: process.env.TOKEN || "OTU5NzE3MzgxNjY2NjQ0MDQw.GbFU4m.qxLOcDN_ejl6u6UKkfwP3PndVQvq8ULkFiXWJc",
  PREFIX: process.env.PREFIX || "ayaka!",
  embed: {
    color: process.env.color || "#220f80",
    wrongcolor: process.env.wrongcolor || "#8a0808",
    footertext: "© Ramdan 2023",
  },
  emoji: {
    ERROR: "❌",
    SUCCESS: "✅",
  ...
  // others
  guildID: process.env.GUILD_ID || "1059399710542135307", // for slash command
  mongodb: process.env.MONGO_URL || "mongodb+srv://ramdan:Ramdan2006@cluster0.tryqrnr.mongodb.net/?retryWrites=true&w=majority",
  filters: {
  ...
  links: {
    inviteURL:
      ...
      `https://discord.com/oauth2/authorize?client_id=959717381666644040&permissions=8&scope=bot`,
    DiscordServer: process.env.DiscordServer || `https://discord.gg/B3VHqqWtMy`,
    VoteURL: process.env.VoteURL || `https://top.gg/bot/959717381666644040/vote`,
    Website: `-`,
  },
  options: {
    embedFooter: true,
